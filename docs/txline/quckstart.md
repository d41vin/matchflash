...
[​](https://txline.txodds.com/documentation/quickstart#overview)
...
[​](https://txline.txodds.com/documentation/quickstart#getting-started)

Getting Started

**Want to try for free?** Check out our [World Cup Free Tier](https://txline.txodds.com/documentation/worldcup) for instant access to World Cup and International Friendlies data with no payment required.

Choose the path that matches your use case:

- **Free World Cup path**: Follow the [World Cup Free Tier](https://txline.txodds.com/documentation/worldcup) guide for service levels 1 or 12. No TxL purchase is required.
...
[​](https://txline.txodds.com/documentation/quickstart#select-your-network)
...
For a runnable devnet version of the activation and stream flow, use the scripts in [Runnable Devnet Examples](https://txline.txodds.com/documentation/examples/devnet-examples). They include free-tier activation, odds and scores streams, fixture validation, and `validateStatV2` examples.

##

[​](https://txline.txodds.com/documentation/quickstart#purchase-txl-optional)

Purchase TxL (Optional)

**Note**: Purchasing TxL tokens is optional. We offer [free tiers for World Cup and International Friendlies](https://txline.txodds.com/documentation/worldcup) data with no payment required. View all [subscription tiers](https://txline.txodds.com/documentation/subscription-tiers) to see free and premium options.

In order to purchase TxL, your wallet will need to be funded with USDT. If you don’t have USDT on Solana, you can swap for it using [Jupiter](https://jup.ag/) or another exchange. TxL purchases use a 2-step process: request a quote from the backend, then verify and sign the transaction locally.

###

[​](https://txline.txodds.com/documentation/quickstart#step-1-request-purchase-quote)
...
[​](https://txline.txodds.com/documentation/quickstart#step-2-verify-and-sign-transaction)
...
[​](https://txline.txodds.com/documentation/quickstart#subscribe-on-chain)
...
[​](https://txline.txodds.com/documentation/quickstart#activate-your-api-token)
...
[​](https://txline.txodds.com/documentation/quickstart#credential-lifecycle)
...
[​](https://txline.txodds.com/documentation/quickstart#next-steps)

Next Steps

- View the complete [API Reference](https://txline.txodds.com/api-reference/authentication/start-a-new-guest-session) to explore all available endpoints
- Check out [Subscription Tiers](https://txline.txodds.com/documentation/subscription-tiers) for pricing and plan options
- Try the [World Cup Free Tier](https://txline.txodds.com/documentation/worldcup) for instant free access
- Run the [Runnable Devnet Examples](https://txline.txodds.com/documentation/examples/devnet-examples) for end-to-end devnet activation, streaming, and validation
- Use [Troubleshooting](https://txline.txodds.com/documentation/examples/troubleshooting) to diagnose activation, streaming, and validation errors
